/*
    SpotifyWebRequest.cpp
    Brandon Luu
    09/23/2023

    This class provides the functionality to the SpotifyWebRequest.h header methods.
*/
...
void SpotifyWebRequest::init(string code, int access = 0) {
